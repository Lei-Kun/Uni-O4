...
class LeggedRobot(BaseTask):
    ...
    def quat_to_euler(self, q):
        ...
        return roll, pitch, yaw # or [roll, pitch, yaw]
    ...
    def compute_observations(self):
        ...
        # roll, pitch, yaw = self.quat_to_euler(self.base_quat[:,:])
        # euler_angles = torch.stack([roll, pitch, yaw], dim=1)
        # self.obs_buf = torch.cat((self.obs_buf, euler_angles), dim=-1)
    ...
    def _resample_commands(self, env_ids):
        ...
        for i, (category, env_ids_in_category, curriculum) in enumerate(
            ...
            # self.commands[env_ids_in_category, :4] = torch.round(self.commands[env_ids_in_category, :4]*10)/10
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        # noise_vec = torch.cat((noise_vec,
        #                            torch.ones(3) * noise_scales.contact_states * noise_level,
        #                            ), dim=0)
